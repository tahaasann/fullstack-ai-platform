...
import { getEmploymentGapGuide } from '../api/client';
...
export default function EmploymentGapGuidePage() {
  ...
  useEffect(() => {
    getEmploymentGapGuide().then(setGuide).catch(console.error);
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Istihdam Boslugu Rehberi</h1>
